...
d3.csv("RaceVGender.csv").then(data => {
    ...
    svg.append("text")
        ...
        .text("Average Wage by Race and Gender");
        ...
        .on("mouseover", function(event, d) {
            ...
            tooltip
                ...
                .html(`
                    ...
                    Female Wage: $${d.Female.toFixed(2)}<br>
                    Female Employees: ${d["Female Count"].toLocaleString()}
                `);
        })
    ...
    chart.selectAll(".male")
        ...
        .on("mouseover", function(event, d) {
            ...
            tooltip
                ...
                .html(`
                    <strong>${d.Race}</strong><br>
                    Male Wage: $${d.Male.toFixed(2)}<br>
                    Male Employees: ${d["Male Count"].toLocaleString()}
                `);
        })
        .on("mousemove", function(event) {
    ...
    chart.selectAll(".diff")
        ...
        .attr("y", d => y(d.Race) + y.bandwidth() / 2 + 5)
        .attr("class", "label")
        .text(d => `Gap: $${d.Difference.toFixed(2)}`);

    const legend = svg.append("g")
        .attr("transform", `translate(${width + margin.left + 35},75)`);
